...
with open("/home/cike/HJS/wiseSight/data/toolFunctions.json", "r", encoding="utf-8") as f:
    wiseSight_tool = json.load(f)
assert wiseSight_tool == toolFunctions, "function not updated"
